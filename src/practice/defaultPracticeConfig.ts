...
export const movingBallPresetCatalog: readonly MovingBallPresetDefinition[] = [
  {
    ...
    activeCopy: 'Follow the centered sweep softly.',
  ...
  },
  {
    ...
    activeCopy: 'Follow the lower, middle, and eye-level lanes softly.',
  ...
  },
  {
    ...
    activeCopy: 'Let the sweep step down, then meet it at center.',
...
export const breathingPresetCatalog: readonly BreathingPresetDefinition[] = [
  {
    ...
    activeCopy: 'Let the inhale stay easy and the exhale taper out.',
  ...
  },
  {
    ...
    activeCopy: 'Follow the inhale and let the longer exhale soften.',
    pattern: 'extended-exhale',
    inhaleMs: 4000,
    inhaleTopUpMs: null,
    holdAfterInhaleMs: null,
  ...
  },
  {
    ...
    activeCopy: 'Keep both phases even and quiet.',
    pattern: 'balanced',
    inhaleMs: 5000,
    inhaleTopUpMs: null,
    holdAfterInhaleMs: null,
  ...
  },
  {
    ...
    activeCopy: 'Move through each phase evenly.',
    pattern: 'box',
    inhaleMs: 4000,
    inhaleTopUpMs: null,
  ...
  },
  {
    ...
    activeCopy: 'Take one easy inhale, add a small top-up, then exhale slowly.',
